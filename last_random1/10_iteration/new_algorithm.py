...
# # t1, r1 = schedule(rack_number, 64, 70, arrive_time[:70], worker_num[:70], agg_time[:70], d_worker[:70], 0, t_len, 0, b_tor,
# #                 b_oxc_port, port_num, b_unit, 0.2)
# # print("noINC-FCFS:",t1, r1,time.time()-start_time1)


# # start_time1=time.time()
# # t2, r2 = schedule(rack_number, 64, 70, arrive_time[:70], worker_num[:70], agg_time[:70], d_worker[:70], 1, t_len, 0, b_tor,
# #                 b_oxc_port, port_num, b_unit, 0.2)
# # print("noINC-Algo:",t2, r2,time.time()-start_time1)


# # start_time1=time.time()
# # t3, r3 = schedule(rack_number, 64, 70, arrive_time[:70], worker_num[:70], agg_time[:70], d_worker[:70], 0, t_len, inc, b_tor,
# #                 b_oxc_port, port_num, b_unit, 0.2)
# # print("INC-FCFS:",t3, r3,time.time()-start_time1)


# start_time2=time.time()
# t4, r4 = schedule(rack_number, 64, 70, arrive_time[:70], worker_num[:70], agg_time[:70], d_worker[:70], 1, t_len, inc, b_tor,
#                 b_oxc_port, port_num, b_unit, 0.2)
