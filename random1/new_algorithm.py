...
t1, r1 = schedule(rack_number, 64, 100, arrive_time[:1400], worker_num[:1400], agg_time[:1400], d_worker[:1400], 0, 5, 0, b_tor,
                b_oxc_port, port_num, 1, 0.2)
print("noINC-FCFS:",t1, r1)

t2, r2 = schedule(rack_number, 64, 100, arrive_time[:1400], worker_num[:1400], agg_time[:1400], d_worker[:1400], 1, 5, 0, b_tor,
                b_oxc_port, port_num, 1, 0.2)
print("noINC-Algo:",t2, r2)
# start_time1=time.time()
t3, r3 = schedule(rack_number, 64, 100, arrive_time[:1400], worker_num[:1400], agg_time[:1400], d_worker[:1400], 0, 5, 10, b_tor,
                b_oxc_port, port_num, 1, 0.2)
...
t4, r4 = schedule(rack_number, 64, 100, arrive_time[:1400], worker_num[:1400], agg_time[:1400], d_worker[:1400], 1, 5, 10, b_tor,
                b_oxc_port, port_num, 1, 0.2)
print("INC-Algo:",t4, r4)
# end_time2=time.time()
# print("span_time:",end_time1-start_time2)
